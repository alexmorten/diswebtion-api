u1 = User.create(firstname:"Tom",lastname:"Burton",email:"abc@email.com",password:"12345678")
u2 = User.create(firstname:"Max",lastname:"Mustermann",email:"def@email.com",password:"12345678")
