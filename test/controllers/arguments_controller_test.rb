...
class ArgumentsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create argument" do
    assert_difference('Argument.count') do
      post arguments_url, params: { argument: { description: @argument.description, side_id: @argument.side_id, title: @argument.title } }, as: :json
    end
  ...
  test "should update argument" do
    patch argument_url(@argument), params: { argument: { description: @argument.description, side_id: @argument.side_id, title: @argument.title } }, as: :json
    assert_response 200
  end
