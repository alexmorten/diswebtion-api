...
class ConditionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create condition" do
    assert_difference('Condition.count') do
      post conditions_url, params: { condition: { description: @condition.description, title: @condition.title, topic_id: @condition.topic_id } }, as: :json
    end
  ...
  test "should update condition" do
    patch condition_url(@condition), params: { condition: { description: @condition.description, title: @condition.title, topic_id: @condition.topic_id } }, as: :json
    assert_response 200
  end
